...
export default function ServicesPreview() {
  ...
  return (
    <section ref={sectionRef} className="relative py-24 lg:py-32 bg-navy-950 overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-navy-500/5 via-transparent to-transparent pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="sp-title text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="mt-4 text-base sm:text-lg text-navy-300/60">
        ...
        <div className="mt-10 text-center">
          <Link
            href="/servicios"
            className="inline-flex items-center gap-2 px-7 py-3.5 bg-gradient-to-r from-navy-500 to-navy-400 text-white font-semibold rounded-2xl shadow-lg shadow-navy-500/20 hover:shadow-navy-500/35 hover:-translate-y-0.5 transition-all duration-300 text-sm"
          >
